...
@riverpod
Future<BookingModel> bookingDetail(Ref ref, String bookingId) async {
...
@riverpod
Future<List<BookingModel>> myBookings(Ref ref) async {
  final userId = Supabase.instance.client.auth.currentUser?.id;
  if (userId == null) return [];
  return BookingService().fetchUserBookings(userId);
}

// bookingProvider is generated by build_runner as:
//   @ProviderFor(Booking)
